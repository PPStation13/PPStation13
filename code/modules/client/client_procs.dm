	...
	//SECURITY//
	////////////
#define UPLOAD_LIMIT		6291456 // hippie -- value raised from 1MB to 3MB (old value: 1048576)	//Restricts client uploads to the server to 1MB //Could probably do with being lower.
